"""
Utility script to run all experiments.

This is mostly intended to be used for testing.
"""
import argparse
from tablebench.core import DomainSplitter, TabularDataset, TabularDatasetConfig

from tablebench.datasets.experiment_configs import EXPERIMENT_CONFIGS
from tablebench.models import get_estimator


def main(cache_dir, model):
    for experiment, expt_config in EXPERIMENT_CONFIGS.items():
