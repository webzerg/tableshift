...
class ExponentiatedGradient(fairlearn.reductions.ExponentiatedGradient):
    ...
    def __init__(self, domain_feature_colname: List, **kwargs):
        ...
        # Only single column currently supported.
        assert isinstance(domain_feature_colname, list) and len(
            domain_feature_colname) == 1

        # We save the names of the sensitive feature as a class attribute
